export const environment = {
    ...
    URL_REFERAL: 'https://apitestexito.azure-api.net/QA-clickam-md-apireferral/api/Link/SaveLink',
    URL_REPORT: 'https://apitestexito.azure-api.net/QA-clickam-md-apicontent/api/',
