export const environment = {
  production: true,
  URL_SECURITY: 'https://apimexito.azure-api.net/PD-clickam-md-apisecurity/api/Authentication/',
  URL_PROFILE: 'https://apimexito.azure-api.net/PD-clickam-md-apiprofile/api/userprofile/',
