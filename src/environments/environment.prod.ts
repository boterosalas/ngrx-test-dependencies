export const environment = {
  ...
  URL_VALIDATE_EMPLOYEE: 'https://apimexito.azure-api.net/PD-clickam-md-apiprofile/api/',
  ...
  URL_MASTER: 'https://apitestexito.azure-api.net/PD-clickam-md-apimasterdata/api/',
